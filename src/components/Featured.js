        ...
        <>
            ...
            <img
              src={
                random.backdrop_path === null
                  ...
                  ? `${posterImage}${random.poster_path}`
          ...
          <div className="featured__content">
            ...
            <div className="featured__lead">
              <h2 className="lead__content__title">
                {random.title || random.name}
              </h2>
              <div className="lead__content__icons">
                <Link
                  className="lead__content__icons__button"
                  to={
                    random.title
                      ? `/search/movie/${random.id}`
                      : `/search/tv/${random.id}`
                  }
                >
                  <i className="lead__content__icons__icon fas fa-play" />
                  Play
                </Link>
                <button className="lead__content__icons__button">
                  <i className="lead__content__icons__icon fas fa-plus" />
                  My list
                </button>
              </div>
